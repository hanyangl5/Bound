...
inline constexpr uint32 MAX_RENDER_TARGET_ATTACHMENTS = 8;
inline constexpr uint32 MAX_VERTEX_BINDINGS = 15;
inline constexpr uint32 MAX_VERTEX_ATTRIBS = 15;
inline constexpr uint32 MAX_DESCRIPTOR_SET_COUNT = 8;
inline constexpr uint32 MAX_SET_BINDING_COUNT = 64;
// VkPhysicalDeviceLimits::maxVertexInputBindings
inline constexpr uint32 MAX_VERTEX_BUFFER_BINDING = 32;
inline constexpr uint32 MAX_SEMANTIC_NAME_LENGTH = 128;
inline constexpr uint32 MAX_DEBUG_NAME_LENGTH = 128;
inline constexpr uint32 MAX_MIP_LEVELS = 0xFFFFFFFF;
inline constexpr uint32 MAX_SWAPCHAIN_IMAGES = 3;
inline constexpr uint32 MAX_GPU_VENDOR_STRING_LENGTH = 64; //max size for GPUVendorPreset strings
inline constexpr uint32 MAX_SHADER_STAGE_COUNT = 5;        //max size for GPUVendorPreset strings
inline constexpr uint32 MAX_TEXTURE_SUBRESOURCE_COUNT = 256;
...
enum class gal_error_code : uint32 {
    SUC,
    ERR,
...
MAKE_ENUM_FLAG(uint32, gal_texture_flag)
enum class gal_shader_stage {
    ...
    ALL_GRAPHICS = ((uint32)gal_shader_stage::VERT | (uint32)gal_shader_stage::TESC | (uint32)gal_shader_stage::TESE |
                    (uint32)gal_shader_stage::GEOM | (uint32)gal_shader_stage::FRAG),
...
MAKE_ENUM_FLAG(uint32, gal_shader_stage)

inline constexpr uint32 gal_shader_stage_count = 7;
...
enum class gal_descriptor_type : uint32 {
    UNDEFINED = 0,
    // constant buffer
    CONSTANT_BUFFER = 1 << 0,
    // read write buffer
...
MAKE_ENUM_FLAG(uint32, gal_descriptor_type)

enum class gal_resource_state : uint32 {
    UNDEFINIED = 0,
...
MAKE_ENUM_FLAG(uint32, gal_resource_state)
...
//MAKE_ENUM_FLAG(uint32, gal_memory_flag);
...
MAKE_ENUM_FLAG(uint32, gal_buffer_flag)
...
//    uint32 mMissShaderCount;
//    uint32 mHitGroupCount;
//    // #TODO : Remove this after adding shader reflection for raytracing shaders
//    uint32 mPayloadSize;
//    // #TODO : Remove this after adding shader reflection for raytracing shaders
//    uint32 mAttributeSize;
//    uint32 mMaxTraceRecursionDepth;
//    uint32 mMaxRaysCount;
//};
...
DECLARE_GAL_HANDLE(gal_descriptor_set) { uint32 set_index; };
