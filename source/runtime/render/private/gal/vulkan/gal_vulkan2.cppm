...
export module gal_vk;

export namespace bd {
namespace gal {
//
//class gal_impl_null : public gal_interface<gal_impl_null> {
//#ifndef GAL_IMPL_NULL
//#define GAL_IMPL_NULL
...
class gal_impl_null : public gal_interface<gal_impl_null> {
  public:
    ...
    gal_error_code create_instance(gal_desc *gal_desc, gal_context *context) {
        ...
        bd::stl::vector<const char *> required_instance_layers;
        bd::stl::vector<const char *> required_instance_extensions;
        ...
        bd::stl::vector<VkLayerProperties> available_layers(available_layer_count);
        bd::stl::vector<VkExtensionProperties> available_extensions(available_extension_count);
    ...
    gal_error_code create_device(gal_desc *gal_desc, gal_context *context) {
        ...
        bd::stl::vector<const char *> required_device_extensions;
        bd::stl::vector<const char *> required_device_layers;
        ...
        bd::stl::vector<VkPhysicalDevice> physical_devices(physical_device_count);
        ...
        // pick gpu
        auto pick_gpu = [&](bd::stl::array<uint32, 3> &queue_family_indices) -> gal_error_code {
            for (const auto &physical_device : physical_devices) {
                ...
                bd::stl::vector<VkQueueFamilyProperties> queue_family_properties(queue_family_count);
                ...
                bd::stl::vector<VkLayerProperties> available_device_layers(available_layer_count);
                vkEnumerateDeviceLayerProperties(physical_device, &available_layer_count,
                                                 available_device_layers.data());

                vkEnumerateDeviceExtensionProperties(physical_device, layer_name, &available_extension_count, nullptr);
                bd::stl::vector<VkExtensionProperties> available_device_extensions(available_extension_count);
        ...
        bd::stl::array<uint32, 3> queue_family_indices;
        ...
        bd::stl::set<uint32> queue_family_indices_set(queue_family_indices.begin(), queue_family_indices.end());
        bd::stl::vector<VkDeviceQueueCreateInfo> device_queue_create_info(queue_family_indices_set.size());
        uint32 idx = 0;
        bd::stl::array<uint32, 3> required_queue_family_indices;
    ...
    gal_error_code create_buffer(gal_context context, gal_buffer_desc *desc, gal_buffer *buffer) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_buffer *vk_buf = bd::memory::alloc<bd::gal::vk_buffer>();
        if (vk_buf == nullptr) {
            return gal_error_code::ERR;
        }
    ...
    gal_error_code create_texture(gal_context context, gal_texture_desc *desc, gal_texture *texture) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_texture *vk_tex = bd::memory::alloc<bd::gal::vk_texture>();
    ...
    gal_error_code create_sampler(gal_context context, gal_sampler_desc *sampler_desc, gal_sampler *sampler) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_sampler *vk_spl = bd::memory::alloc<bd::gal::vk_sampler>();
...
#error PLATFORM NOT SUPPORTED
        ...
        bd::stl::vector<VkSurfaceFormatKHR> formats;

        // Get surface formats count
        result =
            vkGetPhysicalDeviceSurfaceFormatsKHR(vk_ctx->active_gpu, vk_sc->m_surface, &surfaceFormatCount, nullptr);
        if (result != VK_SUCCESS) {
            return gal_error_code::ERR;
        }
        ...
        bd::stl::vector<VkPresentModeKHR> modes;
        ...
        bd::stl::array<VkPresentModeKHR, preferredModeCount> preferredModeList = {
        ...
        bd::stl::array<VkCompositeAlphaFlagBitsKHR, 4> compositeAlphaFlags = {
        ...
        result = (vkGetSwapchainImagesKHR(vk_ctx->device, vk_sc->m_swap_chain, &imageCount,
                                          vk_sc->swap_chain_images.data()));
        if (result != VK_SUCCESS) {
            return gal_error_code::ERR;
        }
    ...
    gal_error_code create_shader_program(gal_context context, gal_shader_program_desc *desc,
        ...
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_shader_program *vk_sp = bd::memory::alloc<bd::gal::vk_shader_program>();
        if (vk_sp == nullptr) {
            return gal_error_code::ERR;
        }
    ...
    gal_error_code create_pipeline_cache(gal_context context, gal_pipeline_cache_desc *desc,
        ...
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_pipeline_cache *vk_pc = bd::memory::alloc<bd::gal::vk_pipeline_cache>();
        if (vk_pc == nullptr) {
            return gal_error_code::ERR;
        }
    ...
    gal_error_code create_compute_pipeline(gal_context context, gal_pipeline_desc *desc, gal_pipeline *pipeline) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_pipeline *vk_pipe = bd::memory::alloc<bd::gal::vk_pipeline>();
        ...
        VkPipelineCache pipeline_cache =
            desc->pipeline_cache != nullptr
                ? reinterpret_cast<vk_pipeline_cache *>(desc->pipeline_cache)->pipeline_cache
                : nullptr;

        VkResult result = vkCreateComputePipelines(vk_ctx->device, pipeline_cache, 1, &pipeline_create_info, nullptr,
                                                   &vk_pipe->pipeline);
    ...
    gal_error_code create_graphics_pipeline(gal_context context, gal_pipeline_desc *desc, gal_pipeline *pipeline) {
        ...
        uint32 stage_count = 0;
        bd::stl::array<VkPipelineShaderStageCreateInfo, 5> stages;
        ...
        bd::stl::array<VkVertexInputBindingDescription, MAX_VERTEX_BINDINGS> input_bindings{};
        uint32 input_attribute_count = 0;
        bd::stl::array<VkVertexInputAttributeDescription, MAX_VERTEX_ATTRIBS> input_attributes{};
        ...
        bd::stl::array<VkPipelineColorBlendAttachmentState, MAX_RENDER_TARGET_ATTACHMENTS> cbAtt{};
        ...
        bd::stl::array<VkDynamicState, 5> dyn_states = {
    ...
    //    vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    //    *pipeline = reinterpret_cast<gal_pipeline>(new bd::gal::vk_pipeline);
    ...
    gal_error_code create_descriptor_pool(gal_context context, vk_descriptor_pool_desc *desc, VkDescriptorPool *pool) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    ...
    gal_error_code destroy_descriptor_pool(gal_context context, vk_descriptor_pool *pool) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
    ...
    gal_error_code get_descriptor_set(gal_context context, gal_descriptor_set_desc *desc, uint32 set_count,
        ...
        //vk_descriptor_set *vk_ds = bd::memory::alloc<bd::gal::vk_descriptor_set>();
        ...
        vk_descriptor_set *vk_ds = static_cast<bd::gal::vk_descriptor_set *>(
            bd::memory::amalloc(set_count * sizeof(bd::gal::vk_descriptor_set)));
        if (vk_ds == nullptr) {
            return gal_error_code::ERR;
        }

        bd::stl::vector<VkDescriptorSet> vk_sets;
        for (uint32 i = 0; i < set_count; i++) {
            vk_sets.push_back(vk_ds[i].set);
        }
        bd::stl::vector<VkDescriptorSetLayout> set_layouts;
    ...
    gal_error_code update_descriptor_set(gal_context context, gal_descriptor_set_update_desc *update_desc,
        ...
        bd::stl::vector<VkDescriptorUpdateData> descriptor_updates;
        ...
        for (uint32 i = 0; i < update_desc->count; i++) {
            ...
            case gal_descriptor_type::SAMPLER:
                update_data.image_info.sampler =
                    reinterpret_cast<vk_sampler *>(t_update_data.desc.s.sampler)->m_sampler;
                break;
            default:
                return gal_error_code::ERR;
            }
    ...
    gal_error_code create_root_signature(gal_context context, gal_root_signature_desc *desc,
        ...
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_root_signature *vk_rs = bd::memory::alloc<bd::gal::vk_root_signature>();
        if (vk_rs == nullptr) {
            return gal_error_code::ERR;
        }
        ...
        bd::stl::array<VkDescriptorSetLayoutCreateInfo, MAX_DESCRIPTOR_SET_COUNT> set_layouts_ci;
        //bd::stl::array<uint32, MAX_DESCRIPTOR_SET_COUNT> set_binding_offsets;
        bd::stl::vector<VkDescriptorSetLayoutBinding> bindings;
        //bd::stl::vector<uint32> binding_prefix_sum(refl->sets.size(), );
        bd::stl::vector<uint32> binding_offsets(refl->sets.size());
        uint32 total_binding_count = 0;
        bd::stl::map<uint32, uint32> set_index_map;
        ...
        bd::stl::vector<VkPushConstantRange> push_constants;
        ...
        //bd::stl::vector<VkDescriptorUpdateTemplateEntry> descriptor_update_template_entries();
        //descriptor_update_template_entries.resize(total_binding_count);
        bd::stl::vector<bd::stl::vector<VkDescriptorUpdateTemplateEntry>> descriptor_update_template_entries;
    ...
    gal_error_code wait_fences(gal_context context, gal_fence *fences, uint32 count) {
        ...
        bd::stl::vector<VkFence> submit_fences;
    ...
    gal_error_code create_command_pool(gal_context context, gal_command_pool_desc *desc,
        ...
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_command_pool *vk_cmd_pool = bd::memory::alloc<bd::gal::vk_command_pool>();
    ...
    gal_error_code get_command_list(gal_context context, gal_command_list_desc *desc, gal_command_list *command) {
        vk_context *vk_ctx = reinterpret_cast<vk_context *>(context);
        vk_command_list *vk_cmd = bd::memory::alloc<bd::gal::vk_command_list>();
    ...
    gal_error_code cmd_resource_barrier(gal_command_list command, uint32 buffer_barrier_count,
        ...
        bd::stl::vector<VkBufferMemoryBarrier> bbs;
        ...
        bd::stl::vector<VkImageMemoryBarrier> tbs;
        ...
        for (uint32 i = 0; i < texture_barrier_count; i++) {
            ...
            if (texture_barrier->op == queue_op::ACQUIRE &&
                texture_barrier->src_state != gal_resource_state::UNDEFINIED) {
            ...
            if (texture_barrier->op == queue_op::RELEASE &&
                texture_barrier->src_state != gal_resource_state::UNDEFINIED) {
        ...
        if (!bbs.empty() || !tbs.empty()) {
            vkCmdPipelineBarrier(vk_cmd->m_command, srcStageMask, dstStageMask, 0, 0, nullptr,
                                 static_cast<uint32>(bbs.size()), bbs.data(), static_cast<uint32>(tbs.size()),
                                 tbs.data());
        }
        return gal_error_code::SUC;
    }
    ...
    gal_error_code cmd_bind_vertex_buffer(gal_command_list command, uint32 vertex_buffer_count,
        ...
        bd::stl::array<VkBuffer, MAX_VERTEX_BUFFER_BINDING> buffers;
        bd::stl::array<VkDeviceSize, MAX_VERTEX_BUFFER_BINDING> vb_offsets;
    ...
    gal_error_code cmd_bind_push_constant(gal_command_list command, gal_root_signature root_signature, const char *name,
        ...
        auto it = vk_rs->resource_map.find(bd::stl::str(name));
    ...
    gal_error_code cmd_update_subresources(gal_command_list command, gal_texture dst, gal_buffer src,
        ...
        bd::stl::vector<VkBufferImageCopy> regions(subresource_count);
    ...
    gal_error_code cmd_set_shading_rate() { return gal_error_code::SUC; }
    ...
    gal_error_code add_queue(gal_context context, gal_queue_desc *desc, gal_queue *queue) {
        ...
        vk_queue *vk_q = bd::memory::alloc<bd::gal::vk_queue>();
        if (vk_q == nullptr) {
            return gal_error_code::ERR;
        }
        *vk_q = *t_queue;
    ...
    gal_error_code queue_submit(gal_queue queue, gal_queue_submit_desc *desc) {
        ...
        bd::stl::vector<VkCommandBuffer> cmds;
        for (uint32 i = 0; i < cmdCount; ++i) {
            cmds.push_back(reinterpret_cast<vk_command_list *>(ppCmds[i])->m_command);
        }

        bd::stl::vector<VkSemaphore> wait_semaphores;
        bd::stl::vector<VkPipelineStageFlags> wait_masks;
        ...
        bd::stl::vector<VkSemaphore> signal_semaphores;
    ...
    gal_error_code acquire_next_image(gal_context context, gal_swap_chain swap_chain, gal_semaphore signal_semaphore,
        ...
        if (fence != nullptr) {
            ...
            vk_res =
                vkAcquireNextImageKHR(vk_ctx->device, vk_sc->m_swap_chain, UINT64_MAX, vk_s->semaphore, VK_NULL_HANDLE,
                                      image_index); //-V522
    ...
    //gal_error_code create_srvuav(gal_context context, gal_buffer buffer)
    //{
