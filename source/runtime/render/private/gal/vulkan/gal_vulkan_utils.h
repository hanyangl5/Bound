...
constexpr VkImageType utils_to_vk_image_type(gal_texture_dimension dimension) {
    switch (dimension) {
    case bd::gal::gal_texture_dimension::_1D:
        return VK_IMAGE_TYPE_1D;
    case bd::gal::gal_texture_dimension::_2D:
        return VK_IMAGE_TYPE_2D;
    case bd::gal::gal_texture_dimension::_3D:
...
constexpr VkImageViewType utils_to_vk_image_view_type(gal_texture_dimension dimension) {
    ...
    case bd::gal::gal_texture_dimension::CUBE:
        return VK_IMAGE_VIEW_TYPE_CUBE;
    case bd::gal::gal_texture_dimension::_1D_ARRAY:
        return VK_IMAGE_VIEW_TYPE_1D_ARRAY;
    case bd::gal::gal_texture_dimension::_2D_ARRAY:
        return VK_IMAGE_VIEW_TYPE_2D_ARRAY;
    case bd::gal::gal_texture_dimension::CUBE_ARRAY:
        return VK_IMAGE_VIEW_TYPE_CUBE_ARRAY;
    case bd::gal::gal_texture_dimension::_2D_MS_ARRAY:
        return VK_IMAGE_VIEW_TYPE_2D_ARRAY;
    case bd::gal::gal_texture_dimension::_2D_MS:
        return VK_IMAGE_VIEW_TYPE_2D;
...
constexpr VkSampleCountFlagBits utils_to_vk_sample_count_flags(gal_texture_sample_count samples) {
    switch (samples) {
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_1:
        return VK_SAMPLE_COUNT_1_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_2:
        return VK_SAMPLE_COUNT_2_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_4:
        return VK_SAMPLE_COUNT_4_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_8:
        return VK_SAMPLE_COUNT_8_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_16:
        return VK_SAMPLE_COUNT_16_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_32:
        return VK_SAMPLE_COUNT_32_BIT;
    case bd::gal::gal_texture_sample_count::SAMPLE_COUNT_64:
...
constexpr VkStencilOp utils_to_vk_stencil_op(gal_stencil_op op) {
    switch (op) {
    case bd::gal::gal_stencil_op::UNDEFINED:
        return VK_STENCIL_OP_KEEP;
    case bd::gal::gal_stencil_op::KEEP:
        return VK_STENCIL_OP_KEEP;
    case bd::gal::gal_stencil_op::SET_ZERO:
        return VK_STENCIL_OP_ZERO;
    case bd::gal::gal_stencil_op::REPLACE:
        return VK_STENCIL_OP_REPLACE;
    case bd::gal::gal_stencil_op::INVERT:
        return VK_STENCIL_OP_INVERT;
    case bd::gal::gal_stencil_op::INCR:
        return VK_STENCIL_OP_INCREMENT_AND_WRAP;
    case bd::gal::gal_stencil_op::DECR:
        return VK_STENCIL_OP_DECREMENT_AND_WRAP;
    case bd::gal::gal_stencil_op::INCR_SAT:
        return VK_STENCIL_OP_INCREMENT_AND_CLAMP;
    case bd::gal::gal_stencil_op::DECR_SAT:
...
constexpr VkPolygonMode utils_to_vk_fill_mode(gal_polygon_fill_mode mode) {
    switch (mode) {
    case bd::gal::gal_polygon_fill_mode::SOLID:
        return VK_POLYGON_MODE_FILL;
    case bd::gal::gal_polygon_fill_mode::WIREFRAME:
...
constexpr VkCullModeFlags utils_to_vk_culll_mode_flags(gal_cull_mode mode) {
    switch (mode) {
    case bd::gal::gal_cull_mode::NONE:
        return VK_CULL_MODE_NONE;
    case bd::gal::gal_cull_mode::BACK:
        return VK_CULL_MODE_BACK_BIT;
    case bd::gal::gal_cull_mode::FRONT:
        return VK_CULL_MODE_FRONT_BIT;
    case bd::gal::gal_cull_mode::BOTH:
...
constexpr VkBlendOp utils_to_vk_blend_op(gal_blend_mode bm) {
    switch (bm) {
    case bd::gal::gal_blend_mode::UNDEFINED:
        return VK_BLEND_OP_MAX_ENUM;
    case bd::gal::gal_blend_mode::ADD:
        return VK_BLEND_OP_ADD;
    case bd::gal::gal_blend_mode::SUBTRACT:
        return VK_BLEND_OP_SUBTRACT;
    case bd::gal::gal_blend_mode::REVERSE_SUBTRACT:
        return VK_BLEND_OP_REVERSE_SUBTRACT;
    case bd::gal::gal_blend_mode::MIN:
        return VK_BLEND_OP_MIN;
    case bd::gal::gal_blend_mode::MAX:
...
constexpr VkBlendFactor utils_to_vk_blend_factor(BlendConstant bc) {
    switch (bc) {
    case bd::gal::BlendConstant::ZERO:
        return VK_BLEND_FACTOR_ZERO;
    case bd::gal::BlendConstant::ONE:
        return VK_BLEND_FACTOR_ONE;
    case bd::gal::BlendConstant::SRC_COLOR:
        return VK_BLEND_FACTOR_SRC_COLOR;
    case bd::gal::BlendConstant::ONE_MINUS_SRC_COLOR:
        return VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR;
    case bd::gal::BlendConstant::DST_COLOR:
        return VK_BLEND_FACTOR_DST_COLOR;
    case bd::gal::BlendConstant::ONE_MINUS_DST_COLOR:
        return VK_BLEND_FACTOR_ONE_MINUS_DST_COLOR;
    case bd::gal::BlendConstant::SRC_ALPHA:
        return VK_BLEND_FACTOR_SRC_ALPHA;
    case bd::gal::BlendConstant::ONE_MINUS_SRC_ALPHA:
        return VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA;
    case bd::gal::BlendConstant::DST_ALPHA:
        return VK_BLEND_FACTOR_DST_ALPHA;
    case bd::gal::BlendConstant::ONE_MINUS_DST_ALPHA:
        return VK_BLEND_FACTOR_ONE_MINUS_DST_ALPHA;
    case bd::gal::BlendConstant::SRC_ALPHA_SATURATE:
        return VK_BLEND_FACTOR_SRC_ALPHA_SATURATE;
    case bd::gal::BlendConstant::BLEND_FACTOR:
        return VK_BLEND_FACTOR_CONSTANT_COLOR;
    case bd::gal::BlendConstant::ONE_MINUS_BLEND_FACTOR:
...
constexpr VkFrontFace utils_to_vk_front_face(gal_front_face ff) {
    switch (ff) {
    case bd::gal::gal_front_face::CCW:
        return VkFrontFace::VK_FRONT_FACE_COUNTER_CLOCKWISE;
    case bd::gal::gal_front_face::CW:
...
constexpr VkPipelineBindPoint utils_to_vk_pipeline_bind_point(gal_pipeline_type type) {
    switch (type) {
    case bd::gal::gal_pipeline_type::COMPUTE:
        return VkPipelineBindPoint::VK_PIPELINE_BIND_POINT_COMPUTE;
    case bd::gal::gal_pipeline_type::GRAPHICS:
        return VkPipelineBindPoint::VK_PIPELINE_BIND_POINT_GRAPHICS;
    case bd::gal::gal_pipeline_type::RAYTRACING:
...
constexpr VkIndexType utils_to_vk_index_type(gal_index_type type) {
    switch (type) {
    case bd::gal::gal_index_type::uint32:
        return VkIndexType::VK_INDEX_TYPE_UINT32;
    case bd::gal::gal_index_type::u16:
