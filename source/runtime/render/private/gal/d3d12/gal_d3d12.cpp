...
//            &alloc_desc, &texture_desc, res_states, nullptr, &d3d12_tex->allocation, IID_PPV_ARGS(&d3d12_tex->texture));
//        if (FAILED(res)) {
//            return gal_error_code::ERR;
//        }
//    } else {
...
//        } else {
//            if (texture_desc.DepthOrArraySize > 1) {
//                if (texture_desc.SampleDesc.Count >
//                    static_cast<uint32>(gal::gal_texture_sample_count::SAMPLE_COUNT_1)) {
...
////     return gal_error_code::SUC;
//// }
//gal_error_code d3d12_cmd_dispatch(gal_command_list command, uint32 group_count_x, uint32 group_count_y,
...
//}
//
//gal_error_code d3d12_cmd_set_stencil_reference_value(gal_command_list command, uint32 val) {
//    return gal_error_code::SUC;
//}
//
