...
gal_error_code d3d12_init_gal(gal_context *context) {
    d3d12_context *d3d12_ctx = bd::memory::alloc<d3d12_context>();
...
gal_error_code d3d12_create_device(gal_desc *gal_desc, gal_context *context) {
    ...
    auto pick_gpu = [&](IDXGIFactory6 *factory, IDXGIAdapter4 **gpu, ID3D12Device **device) -> gal_error_code {
        ...
        for (uint32 i = 0; DXGI_ERROR_NOT_FOUND != factory6->EnumAdapterByGpuPreference(
...
gal_error_code d3d12_create_buffer(gal_context context, gal_buffer_desc *desc, gal_buffer *buffer) {
    d3d12_context *d3d12_ctx = reinterpret_cast<d3d12_context *>(context);
    d3d12_buffer *d3d12_buf = bd::memory::alloc<bd::gal::d3d12_buffer>();
...
gal_error_code d3d12_create_texture(gal_context context, gal_texture_desc *desc, gal_texture *texture) {
    ...
    d3d12_context *d3d12_ctx = reinterpret_cast<d3d12_context *>(context);
    d3d12_texture *d3d12_tex = bd::memory::alloc<bd::gal::d3d12_texture>();
    ...
    case D3D12_RESOURCE_DIMENSION_TEXTURE2D: {
        if (gal_descriptor_type::UNDEFINED!= (descriptors & gal_descriptor_type::TEXTURE_CUBE)) {
            ...
            if (texture_desc.DepthOrArraySize > 1) {
                if (texture_desc.SampleDesc.Count > static_cast<uint32>(gal::gal_texture_sample_count::SAMPLE_COUNT_1)) {
                ...
                if (texture_desc.SampleDesc.Count > static_cast<uint32>(desc->sample_count)) {
...
gal_error_code d3d12_create_sampler(gal_context context, gal_sampler_desc *sampler_desc, gal_sampler *sampler) {
    ...
    return gal_error_code::SUC;
    //    d3d12_context *d3d12_ctx = reinterpret_cast<d3d12_context *>(context);
    //*sampler = reinterpret_cast<gal_handle>(new bd::gal::d3d12_sampler);
...
gal_error_code d3d12_get_pipeline_cache_data(gal_context context, gal_pipeline_cache _pipeline_cache, uint64 *_size,
                                             void *_data) {
...
//    return gal_error_code::SUC;
// }
gal_error_code d3d12_get_descriptor_set(gal_context context, gal_descriptor_set_desc *desc, uint32 set_count,
...
gal_error_code d3d12_wait_fences(gal_context context, gal_fence *fences, uint32 count) { return gal_error_code::SUC; }
...
gal_error_code d3d12_cmd_resource_barrier(gal_command_list command, uint32 buffer_barrier_count,
...
gal_error_code d3d12_cmd_bind_vertex_buffer(gal_command_list command, uint32 vertex_buffer_count,
                                            gal_buffer *vertex_buffers, [[maybe_unused]] uint32 *strides, uint64 *offsets) {
    //d3d12_context *d3d12_ctx;
    //d3d12_command_list *d3d12_cmd;
...
//     return gal_error_code::SUC;
// }
gal_error_code d3d12_cmd_dispatch(gal_command_list command, uint32 group_count_x, uint32 group_count_y, uint32 group_count_z) {
    //d3d12_context *d3d12_ctx;
    //d3d12_command_list *d3d12_cmd;
    //
...
//     return gal_error_code::SUC;
// }
gal_error_code d3d12_cmd_draw_instanced(gal_command_list command, uint32 vertex_count, uint32 first_vertex,
...
gal_error_code d3d12_cmd_draw_indexed_instanced(gal_command_list command, uint32 index_count, uint32 first_index,
...
gal_error_code d3d12_cmd_copy_buffer(gal_command_list command, gal_buffer src, gal_buffer dst, uint64 src_offset,
...
gal_error_code d3d12_cmd_set_scissor(gal_command_list command, int32 x, int32 y, uint32 width, uint32 height) {

    return gal_error_code::SUC;
}

gal_error_code d3d12_cmd_set_stencil_reference_value(gal_command_list command, uint32 val) { return gal_error_code::SUC; }
