...
__GAL_HELPER_MACRO__(gal_error_code, get_pipeline_cache_data, gal_context context, gal_pipeline_cache _pipeline_cache, uint64 *size, void *_data);
...
__GAL_HELPER_MACRO__(gal_error_code, get_descriptor_set, gal_context context, gal_descriptor_set_desc *desc, uint32 set_count, gal_descriptor_set *sets);
...
__GAL_HELPER_MACRO__(gal_error_code, cmd_bind_index_buffer, gal_command_list command, gal_buffer index_buffer, gal_index_type index_type, uint64 offset);
__GAL_HELPER_MACRO__(gal_error_code, cmd_bind_vertex_buffer, gal_command_list command, uint32 vertex_buffer_count, gal_buffer *vertex_buffers, uint32 *stides, uint64 *offsets);
...
__GAL_HELPER_MACRO__(gal_error_code, cmd_dispatch, gal_command_list command, uint32 group_count_x, uint32 group_count_y, uint32 group_count_z);
// __GAL_HELPER_MACRO__(gal_error_code, cmd_dispatch_indirect);
__GAL_HELPER_MACRO__(gal_error_code, cmd_draw_instanced, gal_command_list command, uint32 vertex_count, uint32 first_vertex, uint32 instance_count, uint32 first_instance);
__GAL_HELPER_MACRO__(gal_error_code, cmd_draw_indexed_instanced, gal_command_list command, uint32 index_count, uint32 first_index, uint32 instance_count, uint32 first_instance, uint32 first_vertex);
...
__GAL_HELPER_MACRO__(gal_error_code, cmd_copy_buffer, gal_command_list command, gal_buffer src, gal_buffer dst, uint64 src_offset, uint64 dst_offset, uint64 size);
...
__GAL_HELPER_MACRO__(gal_error_code, cmd_update_subresources, gal_command_list command, gal_texture dst, gal_buffer src, uint32 subresource_count, gal_texture_subresource_desc *descs);
...
__GAL_HELPER_MACRO__(gal_error_code, cmd_set_scissor, gal_command_list command, int32 x, int32 y, uint32 width, uint32 height);
